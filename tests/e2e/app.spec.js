...
test('End-to-end user workflow', async () => {
    ...
    const todo = await window.locator('.todo-list');
    ...
    const checkbox = await todoItem.locator('input[type="checkbox"]');
    ...
    const deleteButton = await todoItem.locator('.delete-btn');
